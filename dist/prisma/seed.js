...
async function main() {
    ...
    const post1 = await prisma.post.create({
        data: {
            title: 'Привіт, світ!',
            content: 'Це мій перший пост у новому блозі. Дуже радий приєднатися до спільноти! Тут я ділитимусь своїми думками про технології, програмування та життя.',
    ...
    const post3 = await prisma.post.create({
        data: {
            ...
            content: 'TypeScript дає мені впевненість у коді. Автодоповнення, перевірка типів на етапі компіляції, краща підтримка IDE - все це робить розробку швидшою та безпечнішою. Так, є певна крива навчання, але воно того варте!',
    ...
    const post4 = await prisma.post.create({
        data: {
            ...
            content: 'Server Components, Server Actions, покращена продуктивність - Next.js 14 це справжній game changer! Особливо подобається App Router та те, як легко тепер працювати з серверним кодом.',
    ...
    const post5 = await prisma.post.create({
        data: {
            ...
            content: 'Ранкова рутина: 07:00 - підйом, 07:30 - зарядка, 08:00 - сніданок та планування дня. Потім 4 години глибокої роботи з перервами по Pomodoro. Обід о 13:00, після - менш складні задачі та мітинги. Увечері - навчання та особисті проекти.',
